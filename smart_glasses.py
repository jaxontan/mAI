...
camera -> JPEG video blobs -> local Ollama vision model -> HUD caption.
"""
...
def parse_args(argv: list[str]) -> Settings:
    parser = argparse.ArgumentParser(
        description="Run the local Ollama AI smart-glasses prototype."
    )
    parser.add_argument(
        "--model",
        default=None,
    ...
    model = args.model or os.environ.get("OLLAMA_MODEL", "llava:7b")
